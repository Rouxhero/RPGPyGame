...
/**
 * This is the item provider adapter for a {@link rPGPyGame.Text} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TextItemProvider extends ElementItemProvider {
	...
	protected void addContentPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Text_content_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Text_content_feature", "_UI_Text_type"),
						RPGPyGamePackage.Literals.TEXT__CONTENT, true, false, false,
	...
	public String getText(Object object) {
		String label = ((Text) object).getNameID();
	...
	public void notifyChanged(Notification notification) {
		...
		case RPGPyGamePackage.TEXT__CONTENT:
