 ...
 *******************************************************************************/
package rouxhero.rpgpygame.main;
...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/rouxhero/rpgpygame/main/generate";
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(rPGPyGame.RPGPyGamePackage.class)) {
            resourceSet.getPackageRegistry().put(rPGPyGame.RPGPyGamePackage.eINSTANCE.getNsURI(), rPGPyGame.RPGPyGamePackage.eINSTANCE);
        }
